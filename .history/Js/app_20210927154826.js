const GetElement = function (element) {
  if (element) {
    try {
      ...
      throw `Please check again, Cause The element ' ${element} ' you are trying to select doesnt exist, the following error occured ${err} `;
    }
  }
};
...
document.addEventListener(
  ...
  (function () {
    ...
    hambugger.addEventListener("click", () => {
      console.log(mobileNav, "this is the mobile nav tag");
